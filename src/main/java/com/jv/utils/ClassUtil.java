...
/**
 * Operates on classes without using reflection.</p>
 *
...
public class ClassUtil {
     ...
     * @throws ValidatorException if the bean cannot be instantiated
     */
    public static <T> T instantiate(Class<T> clazz)  {
        if (clazz == null){
            throw new IllegalArgumentException("the clazz is null");
        }
