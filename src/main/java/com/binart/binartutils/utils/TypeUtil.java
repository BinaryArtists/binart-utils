...
public class TypeUtil {
    ...
    /**
     * <p> TypeUtil instances should NOT be constructed in standard
     * programming. Instead, the class should be used as
     * <code>TypeUtil.isAssignable(cls, toClass)</code>. </p> <p> This
    ...
    private static boolean isAssignable(Type type, Class<?> toClass) {
        if (type == null) {
            // consistency with ClassUtil.isAssignable() behavior
