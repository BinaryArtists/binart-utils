...
public class SystemUtil {
     ...
     * @return the system property value with Boolean type.
     */
    public static Boolean getBSystemProperty(final String property, Boolean defaultValue) {
        try {
     ...
     * {@code SystemUtil.FILE_SEPARATOR}.
     * </p>
     * <p>
